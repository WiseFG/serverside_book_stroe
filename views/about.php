	...
	<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">درباره <strong>ما</strong></h2>
					<div id="gmap" class="contact-map" style="direction: rtl;">
                        <p>شرکت کتاب-آنلاین در سال ۱۳۹۵ با هدف دسترسی راحت تر هموطنان عزیز به کتاب های مورد نیاز خود آغاز به کار کرد......</p>
